      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto p-0">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center space-x-3">
            ...
            <Button variant="outline" size="sm" onClick={handleDelete} className="flex items-center space-x-2 text-red-600 hover:text-red-700">
        ...
        <div className="p-6 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {candidate.phone_number && <div className="flex items-center space-x-3">
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                {isEditing ? <div className="flex items-center space-x-2">
                  ...
                  </div> : <Badge>{candidate.application_status === 'To Be Reviewed' ? 'À réviser' : candidate.application_status === 'Relevant' ? 'Pertinent' : 'À rejeter'}</Badge>}
              </div>
            </CardContent>
          </Card>

          {/* Entretien Section */}
          {candidate.interview_date && <Card>
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
              ...
              <CardContent className="space-y-3">
                <div>
                  ...
                  <span>{new Date(candidate.interview_date).toLocaleDateString('fr-FR')}</span>
                </div>
                <div>
                  <span className="font-medium">Recruteur assigné: </span>
                  <span>{getRecruiter()?.name || 'Non assigné'}</span>
                </div>
                <div>
                  <span className="font-medium">Statut d'évaluation: </span>
                  <Badge>{candidate.evaluation_status}</Badge>
                </div>
              </CardContent>
            </Card>}
        </div>
